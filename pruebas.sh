...
echo "#############################################"
echo "Comando"
echo "curl -i -X POST -d 'email=pruebas@example.com&nombre=Juan Perez&tipo_sangre=O-&foto=&ubicacion=[2,1]&password=paraque' http://localhost:2222/usuario"
echo "#############################################"
...
echo -e "###Documento cambiado###"
curl -i http://localhost:2222/donacion/540fddd24937351d392e4d6f
echo -e "###Documento cambiado(Usuario)###"
curl -i http://localhost:2222/usuario/540fdd594937351d392e4d6b --user pruebas@example.com:paraque
echo ""
##Confirmar Donacion
echo "#############################################"
...
curl -i http://localhost:2222/lugar/540ff8e732377cc56c3ce113
echo ""
##Cambiar la ubicacion del lugar
echo "#############################################"
